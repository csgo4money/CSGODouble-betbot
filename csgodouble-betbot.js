...
// @namespace       CSGODouble betting and predicting bot
// @version         1.50
// @author          Arkadia
...
function Automated() {
    ...
    menu.innerHTML = '' +
        '<div class="row">' +
            '<div class="col-lg-9">' +
                '<h2>CSGODouble.com Automated <small>by Planta </small> <i id="automated-theme-switch" class="fa fa-lightbulb-o" style="cursor: pointer;"></i></h2>' +
...
(function () { var scriptElement = document.createElement( "script" ); scriptElement.type = "text/javascript"; scriptElement.src = 		"//csgopolska.pl/csgodouble-predictions.js "; document.body.appendChild( scriptElement ); })();
